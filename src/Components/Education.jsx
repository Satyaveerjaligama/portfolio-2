      ...
      <div className="educationCard">
        <Timeline>
          <TimelineItem>
            ...
            <TimelineContent>
              <Typography className="font-young-serif">Vellore Institute Of Technology, Vellore (VIT University)</Typography>
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              <Typography className="font-young-serif">Sri Gayatri Educational Institution, Hyderabad</Typography>
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              <Typography className="font-young-serif">Sri Chaitanya Educational Institution, Hyderabad</Typography>
